...
class JournalEntryEditScreenState extends State<JournalEntryEditScreen> {
  ...
  Future<bool> _onWillPop() async {
    ...
    if (_titleController.text != widget.entry.title ||
        ...
        builder: (context) => AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              onPressed: () =>
                  Navigator.of(context).pop(false), // User decides not to leave
            ),
            TextButton(
              child: const Text('Discard'),
              onPressed: () => Navigator.of(context)
                  .pop(true), // User decides to leave, discard changes
            ),
          ],
        ),
      );
      ...
      return shouldLeave ??
          false; // If dialog is dismissed, prevent pop (by returning false)
    }
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                minLines:
                    5, // Set minLines to null and maxLines to null for expanding
